...
function App() {
  ...
  return (
    ...
    <div className="flex flex-col lg:flex-row">
      ...
      <img src={img} alt="motivational image" className="w-full h-auto max-w-full lg:w-auto lg:min-h-screen lg:max-w-none lg:ml-4 rounded-xl" /> {/* Adjust image size and position */}
    </div>
